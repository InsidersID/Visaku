...
public struct PDFPreviewSheet: View {
    ...
    func fillPDFFormFields(pdfDocument: PDFDocument){
        ...
        let sampleData: [String: Any] = [
            ...
            "applicantSurnameAtBirth": trip?.account?.additionalInformation?.bornName ?? "Surname at Birth",
            ...
            "applicantNationalityAtBirth": trip?.account?.additionalInformation?.bornNationality ?? "Nationality at Birth",
            "applicantNationalityOther": trip?.account?.additionalInformation?.bornNationality ?? "Nationality",
            ...
            "applicantMaritalPAC": trip?.account?.identityCard?.maritalStatus == .registeredPartnership ? true : false,
            "applicantMaritalSEP": trip?.account?.identityCard?.maritalStatus == .separated ? true : false,
            ...
            "applicantMaritalOther": trip?.account?.identityCard?.maritalStatus == .others ? true : false,
            ...
            "applicantIdCardNumber": trip?.account?.identityCard?.identityId ?? "Identity Card Number",
            ...
            "travelDocTypePOF": trip?.account?.passport?.passportType == .official ? true : false,
            "travelDocTypePSP": trip?.account?.passport?.passportType == .special ? true : false,
            "travelDocTypeAUT": false,
            "travelDocTypeOther": trip?.account?.passport?.passportType == .others ? true : false,
            "travelDocNumber": trip?.account?.passport?.image.count ?? "Travel Document Count",
            ...
            "applicantOccupation": trip?.account?.additionalInformation?.selectedJob ?? "Occupation",
